+++
title = "Choose One \"Done\" Story, Over Two \"Almost Dones\""
date = 2025-05-07
tags = ["Stories"]
+++
As we approach the end of an iteration we need to decide which stories we'll see to completion and which we'll postpone or abandon, so we can reallocate our team's efforts to __finalize__ more work.
